...
evsieve --input  $KEYBOARD_INPUT_1 domain=kb1 grab \
        ...
        --hook   key:scrolllock key:h toggle=:1 exec-shell="evsieve/toggle.sh host" send-key=key:esc@host-kb \
        --hook   key:scrolllock key:v toggle=:2 exec-shell="evsieve/toggle.sh vm" send-key=key:esc@vm-kb \
        --withhold \
